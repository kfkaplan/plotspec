...
#stdno = 164
#waveno = 153
#spectral_lines = lines(['H2_lite.dat','H_and_He.dat', 'neutron_capture_species.dat', 'Fe.dat'], delta_v = [30.0,30.0,30.0, 30.0]) 
#spectral_lines = lines(['H2_lite.dat', 'neutron_capture_species.dat'], delta_v = [30.0, 30.0])
#Select observations of Orion Bar 0,0
#save.name('Orion Bar 00')
#date = 20141023
#frameno = 120
#stdno = 126
#waveno = 118
...
#spectral_lines = lines('H2_all.dat', delta_v = 8.0)
#Select observations of Hb-12
#save.name('Hb 12 PA 90')
#PA = 90
###date = 20140923
###frameno = 290
###stdno = 286
...
#spectral_lines = lines('H2_all.dat', delta_v = -20.0)
#PA = 45
#date = 20141023
#frameno = 84
#stdno = 92
...
#NGC 7023 # The reflection neubla
save.name('NGC 7023')
date = 20140712
frameno = 20
stdno = 8
waveno = 32
spectral_lines = lines('H2_all.dat', delta_v = -19.5) 
...
#test_integrate_region = region(pv, file='hb12_brightspot.reg', background='all') #Grab line fluxes from a user specified region, here defined in this script
test_integrate_region = region(pv, file='ds9.reg', background='all') #Grab line fluxes from a user specified region, set by user on command line
